...
function App() {
  ...
  useEffect(() => {
    const carouselEl = document.getElementById('celebrityCarousel')
  ...
  return (
    <div className="App">
      ...
      <header className="navbar navbar-expand-lg sticky-top header-dark shadow-sm py-2">
...
<span className="text-warning">CELEBRITY COLLABS & EVENT MANAGEMENT</span> 
          <button
          ...
          <div className="collapse navbar-collapse" id="navMenu">
            <ul className="navbar-nav ms-auto align-items-lg-center gap-3">
              ...
              <li className="nav-item">
                <a className="btn btn-theme rounded-pill px-4 py-2 nav-cta" href="#contact">Boost My Brand Visibility</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="row align-items-center gy-5">
            <div className="col-lg-6 order-lg-1">
              <div className="card hero-card overflow-hidden border-0 shadow-lg position-relative">
                ...
                {/* Caption shown below the slider (keeps faces unobstructed) */}
                <div className="carousel-below-caption mt-3 p-3">
                  {celebrities[activeIndex] && (
                    <div className="d-flex w-100 justify-content-between align-items-center">
                      <div className="caption-left d-flex align-items-center">
                        {/* <span className="badge caption-badge">{celebrities[activeIndex].badge}</span> */}
                        <div className="caption-text ms-3">
                          <h5 className="mb-0">{celebrities[activeIndex].name}</h5>
                          <p className="mb-0 small text-white-50">{celebrities[activeIndex].role}</p>
                        </div>
                      </div>
                      <div className="caption-action d-flex align-items-center">
                        <a href="#contact" className="book-btn btn btn-sm">Book Now</a>
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className="row g-4">
            {['Brand Ambassador', 'Celebrity Endorsement', 'Event Appearance', 'Influencer Marketing', 'Image Rights'].map((service) => (
              <div key={service} className="col-md-6 col-lg-4">
                <div className="card h-100 border-0 shadow-sm card_yellow">
          ...
          <div className="row align-items-center gy-4">
            <div className="col-lg-6">
              ...
              <ul className="list-group list-group-flush rounded-4 overflow-hidden shadow-sm mt-4">
                <li className="list-group-item card_yellow">Fast campaign matchmaking for every budget.</li>
                <li className="list-group-item card_yellow">Real influencer insights and verified engagement.</li>
                <li className="list-group-item card_yellow">End-to-end support from concept to execution.</li>
              </ul>
            </div>
            <div className="col-lg-6">
              <div className="row g-3">
                {celebrities.map((item) => (
                  <div key={item.name} className="col-sm-6">
                    <div className="card border-0 shadow-sm h-100 card_yellow">
                      <div className="card-body" >
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center text-white py-5 rounded-4 shadow-lg" style={{ background: 'linear-gradient(135deg, #d90429 0%, #ff6b6b 100%)' }}>
              ...
              <a className="btn btn-theme btn-lg rounded-pill mt-3" href="mailto:hello@celebrate.com">Talk to us now</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-4 border-top">
        <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
          <p className="mb-0 small text-secondary">© 2026 CelebRate.</p>
